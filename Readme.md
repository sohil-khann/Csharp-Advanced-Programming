# 🌉 BridgeLabz Training Program - Advanced Programming
...
- **Language**: C#
- **Testing Framework**: xUnit or MSTest (as configured in test project)
...
```bash
dotnet run --project PracticeProblems.App
```
